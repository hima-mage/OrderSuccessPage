...
namespace HimaMage\OrderSuccessPage\Block;


use HimaMage\OrderSuccessPage\Helper\Data;
...
class Details extends \Magento\Sales\Block\Order\Totals
{
    ...
    {
        return $this->helper->getTitleText();
    }
    ...
    {
        return $this->helper->getTitleSize();
    }
    ...
    {
        return $this->helper->getTitleColor();
    }
